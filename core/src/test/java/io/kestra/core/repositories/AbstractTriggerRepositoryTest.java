...
public abstract class AbstractTriggerRepositoryTest {
    ...
    public final static List<Named<FiltersTestCase>> filtersTestCases = Stream.of(
        ...
        // --- START_DATE (maps to next_evaluation_date) ---
        FiltersTestCase.builder()
            .triggers(List.of(triggerEarlyEval, triggerLateEval))
            .expectedTriggers(List.of(triggerEarlyEval))
            .queryFilter(QueryFilter.builder()
                .field(Field.START_DATE).value(ZonedDateTime.ofInstant(DATE_OLD, ZoneId.of("UTC")))
        ...
        FiltersTestCase.builder()
            ...
            .expectedTriggers(List.of(triggerLateEval))
            .queryFilter(QueryFilter.builder()
                .field(Field.START_DATE).value(DATE_BETWEEN).operation(Op.GREATER_THAN).build())
            .build(),
        ...
        FiltersTestCase.builder()
            ...
            .expectedTriggers(List.of(triggerEarlyEval))
            .queryFilter(QueryFilter.builder()
                .field(Field.START_DATE).value(DATE_BETWEEN).operation(Op.LESS_THAN).build())
            .build(),
        ...
        FiltersTestCase.builder()
            ...
            .expectedTriggers(List.of(triggerEarlyEval, triggerLateEval))
            .queryFilter(QueryFilter.builder()
                .field(Field.START_DATE).value(ZonedDateTime.ofInstant(DATE_NEW, ZoneId.of("UTC")))
                .operation(Op.LESS_THAN_OR_EQUAL_TO).build())
            .build(),

        // --- END_DATE (maps to next_evaluation_date) ---
        FiltersTestCase.builder()
            .triggers(List.of(triggerEarlyEval, triggerLateEval))
            .expectedTriggers(List.of(triggerLateEval))
            .queryFilter(QueryFilter.builder()
                .field(Field.END_DATE).value(ZonedDateTime.ofInstant(DATE_NEW, ZoneId.of("UTC")))
                .operation(Op.EQUALS).build())
            .build(),
        ...
        FiltersTestCase.builder()
            ...
            .expectedTriggers(List.of(triggerLateEval))
            .queryFilter(QueryFilter.builder()
                .field(Field.END_DATE).value(DATE_BETWEEN).operation(Op.GREATER_THAN).build())
            .build(),
        ...
        FiltersTestCase.builder()
            ...
            .expectedTriggers(List.of(triggerEarlyEval))
            .queryFilter(QueryFilter.builder()
                .field(Field.END_DATE).value(DATE_BETWEEN).operation(Op.LESS_THAN).build())
            .build(),
