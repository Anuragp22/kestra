...
public abstract class AbstractJdbcRepository {
    ...
    /**
     * URL query params arrive as {@link String}s, but the {@code attempt_number} column is an
     * {@code integer}. Postgres won't auto-coerce {@code '1'} to {@code 1} (H2 does, masking
     * this in unit tests), so parse before binding through JOOQ.
     */
