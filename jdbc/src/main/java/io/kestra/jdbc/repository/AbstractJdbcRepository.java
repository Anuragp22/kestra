...
public abstract class AbstractJdbcRepository {
    ...
    protected Condition tagsCondition(Object value, QueryFilter.Op operation) {
        throw new InvalidQueryFiltersException("Unsupported field: TAGS");
    }
    ...
    protected Condition applyDateCondition(OffsetDateTime dateTime, QueryFilter.Op operation, String fieldName) {
        return switch (operation) {
